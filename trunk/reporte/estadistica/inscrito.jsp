...
<%	for( aca.catalogo.CatNivelEscuela catNivel: lisNivel){
		...
		ArrayList<aca.alumno.AlumPersonal> lisInscritos = AlumnoL.getListAlumnosInscritosNivel(conElias, escuela, ciclo, catNivel.getNivelId(), "ORDER BY NIVEL_ID, GRADO, GRUPO, CODIGO_ID");
