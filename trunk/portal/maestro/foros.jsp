			  ...
			  <div class="modal-body ">
			  	...
			  	<fieldset>
			        ...
			        <fieldset>
				        <div class="checkbox">
				        	<label>
				          		<input type="checkbox" name="agendado" :id="'agendado-edit' + tema.id" :checked="tema.agendado"> Agendado
				        	</label>
				      	</div>
			      	</fieldset>
			      	<div id="estaAgendado">
			  	...
			  	<fieldset>
			        <div class="checkbox">
			        	<label>
			          		<input type="checkbox" name="visible" :id="'visible-edit' + tema.id" :checked="tema.visible"> Visible
			        	</label>
			      	</div>
			     	</fieldset>
			        ...
			        <div class="checkbox">
			        	<label>
			          		<input type="checkbox" name="cerrado" :id="'cerrado-edit' + tema.id" :checked="tema.cerrado"> Cerrado
			        	</label>
			      	</div>
			     	</fieldset>
			  </div>
