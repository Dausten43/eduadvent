...
public class CicloLista {
	...
	public ArrayList<Ciclo> getListCiclosEmpleadoPlanta(Connection conn, String empleadoId, String orden ) throws SQLException{
		...
		try{
			comando = "SELECT CICLO_ID, CICLO_NOMBRE, F_CREADA, F_INICIAL, F_FINAL, NUM_CURSOS, ESTADO, ESCALA, MODULOS, EDITAR_ACTIVIDAD, CICLO_ESCOLAR, DECIMALES, REDONDEO, NIVEL_EVAL" +
					" FROM CICLO" +
