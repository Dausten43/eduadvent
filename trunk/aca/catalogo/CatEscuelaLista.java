	...
	public ArrayList<CatEscuela> getListAll(Connection conn, String orden ) throws SQLException{
		...
		try{
			comando = "SELECT" +
					...
					" UNION_ID,ORG_ID, DISTRITO, REGION_ID, ESLOGAN, SECTOR, ZONA" +
	...
	public ArrayList<CatEscuela> getListAsociacion(Connection conn, String asociacionId,String orden ) throws SQLException{
		...
		try{
			comando = "SELECT " +
					"ESCUELA_ID, ESCUELA_NOMBRE, NOMBRE_CORTO, " +
					"PAIS_ID, ESTADO_ID, CIUDAD_ID, COLONIA, DIRECCION, TELEFONO, FAX, ASOCIACION_ID, LOGO, ESTADO, FIRMA, SECCION_ID, UNION_ID, ORG_ID, DISTRITO, REGION_ID, ESLOGAN, SECTOR, ZONA  " +
					"FROM CAT_ESCUELA WHERE ASOCIACION_ID = "+asociacionId+" "+orden;		
	...
	public ArrayList<CatEscuela> getListAsociacion(Connection conn, String asociacionId,String distritoId, String orden ) throws SQLException{
		...
		try{
			comando = "SELECT " +
					"ESCUELA_ID, ESCUELA_NOMBRE, NOMBRE_CORTO, " +
					"PAIS_ID, ESTADO_ID, CIUDAD_ID, COLONIA, DIRECCION, TELEFONO, FAX, ASOCIACION_ID, LOGO, ESTADO, FIRMA, SECCION_ID, UNION_ID, ORG_ID, DISTRITO, REGION_ID, ESLOGAN, SECTOR, ZONA  " +
					"FROM CAT_ESCUELA WHERE ASOCIACION_ID = "+asociacionId+" AND DISTRITO = '"+distritoId+"' "+orden;		
	...
	public ArrayList<CatEscuela> getListNivel(Connection conn, String nivelId, String orden ) throws SQLException{
		...
		try{
			comando = "SELECT " +
					...
					" LOGO, ESTADO, FIRMA, SECCION_ID, UNION_ID, ORG_ID, DISTRITO, REGION_ID, ESLOGAN, SECTOR, ZONA  " +
