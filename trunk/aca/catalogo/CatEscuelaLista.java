	...
	public ArrayList<CatEscuela> getListAll(Connection conn, String orden ) throws SQLException{
		...
		try{
			comando = "SELECT" +
					...
					" UNION_ID,ORG_ID, DISTRITO, REGION_ID, ESLOGAN, SECTOR, ZONA, BARRIO_ID, WWW" +
	...
	public ArrayList<CatEscuela> getListNivel(Connection conn, String nivelId, String orden ) throws SQLException{
		...
		try{
			comando = "SELECT " +
					...
					" LOGO, ESTADO, FIRMA, SECCION_ID, UNION_ID, ORG_ID, DISTRITO, REGION_ID, ESLOGAN, SECTOR, ZONA, BARRIO_ID, WWW  " +
