...
<div id="content">
	...
	<form action="evaluarConductaProm.jsp?CursoId=<%=cursoId %>&CicloGrupoId=<%=cicloGrupoId %>" name="forma" method="post">
					...
					<%
						...
						for (aca.ciclo.CicloPromedio prom : lisPromedio) {
							...
							for (aca.kardex.KrdxAlumConducta kardexConductaAlumno: lisKardexConducta) {
								if ( kardexConductaAlumno.getCodigoId().equals(kardex.getCodigoId()) && prom.getPromedioId().equals(kardexConductaAlumno.getPromedioId()) ) {					
